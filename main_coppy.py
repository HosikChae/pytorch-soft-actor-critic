...
parser.add_argument('--env-name', default="VREPy-HalfCheetah-v2",
                    help='Mujoco Gym environment (default: VREPy-HalfCheetah-v2)')
...
parser.add_argument('--max_episode_steps', type=int, default=-1, metavar='N',
                    help='maximum number of episode steps (default: -1)')
